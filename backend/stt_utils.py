...
WHISPER_FORM_PROMPT_FA = (
    ...
    "همودینامیک: SBP اس بی پی، DBP دی بی پی، MAP، HR اچ آر، "
    "دما، Urine output خروجی ادرار، I&O آی او بالانس مثبت یا منفی، Vasopressor. "
    "مثال تنظیمات: مود VCV، PEEP پنج، FiO2 چهل، VT پانصد. "
    "مثال اندازه‌گیری: آر آر توتال بیست، وی تی ای چهارصد و پنجاه، "
    "پیک پرشر بیست و هشت، پلاتو بیست و دو، پیپ اندازه‌گیری پنج، لیک دو، RSBI شصت. "
    "مثال ABG: پی اچ هفت و سی و پنج، پی ای او دو هشتاد، فی او دو چهل. "
    "مثال همودینامیک: اس بی پی صد و بیست، دی بی پی هشتاد، اچ آر نود، "
    "دما سی و هفت درجه، آی او مثبت پانصد، وازوپرسور ندارد. "
    "نه اس تی پی؛ اس بی پی. نه مصیبت؛ مثبت. "
    "آزمایشگاه: هموگلوبین Hb، هماتوکریت Hct، WBC گلبول سفید، پلاکت Platelet، "
    "سدیم Na، پتاسیم K، کلسیم Ca، منیزیم Mg، فسفات Phosphate، "
    "اوره BUN، کراتینین Creatinine، آلبومین Albumin، "
    "AST ALT بیلیروبین Bilirubin، CRP پروکلسیتونین Procalcitonin، "
    "قند خون Glucose، ESR لاکتات Lactate. "
    "ابزارها: CVC کاتتر مرکزی، آرت‌لاین، NG لوله معده، سوند فولی، چست‌تیوب. "
    "مثال آزمایشگاه: هموگلوبین یازده، هماتوکریت سی و پنج، WBC هشت، "
    "پلاکت دویست، سدیم صد و سی و هشت، پتاسیم چهار ممیز دو، کراتینین یک ممیز دو، CRP بیست. "
    "مثال ابزار: سی وی سی دارد، آرت‌لاین دارد، ان جی دارد، سوند فولی دارد، چست‌تیوب ندارد."
)
...
_FORM_TRANSCRIPT_FIXES: tuple[tuple[str, str], ...] = (
    ...
    ("وازوپرسر", "وازوپرسور"),
    ("نداره", "ندارد"),
    # Whisper letter-swap / near-miss on hemo labels
    ("اس تی پی", "اس بی پی"),
    ("اس تیپی", "اس بی پی"),
    ("اس‌تی‌پی", "اس بی پی"),
    ("استیپی", "اس بی پی"),
    ...
    ("I&O مصیبت", "I&O مثبت"),
    ("آی او مصیبت", "آی او مثبت"),
    ("DAMA", "دما"),
    ("dama", "دما"),
    # ABG label garbling
    ("پی اس او دو", "پی ای سی او دو"),
    ("پی اس کو دو", "پی ای سی او دو"),
    ("پی اسو دو", "پی ای سی او دو"),
    ("پا سی او دو", "پی ای سی او دو"),
    ("ام آر ای", "بیکربنات"),
    ("اچ کو سه", "بیکربنات"),
    ("اچ سی او سه", "بیکربنات"),
    ("بی کربنات", "بیکربنات"),
    ("بیکربینات", "بیکربنات"),
    ("بیکرینات", "بیکربنات"),
    ("بیس ایکسس", "بیس اکسس"),
    ("بیس اکزس", "بیس اکسس"),
    ("بیس اگزس", "بیس اکسس"),
    ("اس ای او", "اس ای او دو"),
    # spontaneous variants
    ("اسپانتینیوس", "اسپانتانیوس"),
    ("اسپونتانیوس", "اسپانتانیوس"),
    ("اسپانتنیوس", "اسپانتانیوس"),
    ("اسپانتئوس", "اسپانتانیوس"),
    ("اسپانتانئوس", "اسپانتانیوس"),
    # Lab label garbling
    ("هموگلبین", "هموگلوبین"),
    ("هموگلوبن", "هموگلوبین"),
    ("هموگلوبیم", "هموگلوبین"),
    ...
    ("آلبیومین", "آلبومین"),
    ("البومین", "آلبومین"),
    ("بیلی روبین", "بیلیروبین"),
    ("پروکلسیونین", "پروکلسیتونین"),
    ("پروکالسیتونین", "پروکلسیتونین"),
    ("پروکالسیونین", "پروکلسیتونین"),
    ("ای اس ار", "ای اس آر"),
    ("سرعت رسوب گلبول", "ای اس آر"),
    ("رسوب گلبول", "ای اس آر"),
    ("ESRC", "ESR"),
    ("esrc", "esr"),
    # Vent STT: Whisper often hears «مکس» as «مکرر»
    ("تی آی مکرر", "تی آی مکس"),
    ("تی آی مکسر", "تی آی مکس"),
    ("ti مکرر", "ti مکس"),
    ("صف ممیز", "صفر ممیز"),
    ("بک ممیز", "یک ممیز"),
    ("اوتو پیپ", "اتو پیپ"),
